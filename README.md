...
A production-ready platform for seamless collaboration between humans and AI, featuring ticket management, automated classification, and intelligent response generation.

## Features

- **Human-AI Interface**: Integrated workflow for manual and automated tasks.
- **Intelligent Classification**: Automatically categorize tasks using state-of-the-art AI.
- **Smart Summaries**: AI-generated summaries and suggested replies.
- **Collaborative Workspace**: Comprehensive views for filtering, sorting, and managing threads.
- **Admin Controls**: Robust user and system management.
- **Analytics Dashboard**: Real-time insights into collaboration metrics.
...
2. **Run locally with Docker**
   ...
   ```bash
   docker run -p 3000:3000 --env-file server/.env -e NODE_ENV=production haic
   ```
3. **Deploy to Railway**
